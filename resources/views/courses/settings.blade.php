    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="panel-body" style="float: left">
                <form class="form-horizontal" role="form" method="POST" action="{{ route('storeSettings', ['course' => $course]) }}">
                 {{ csrf_field() }}

                    <div class="form-group">
                        <label class="control-label col-md-4" style="text-align: left">Course Name:</label>

                        <div class="col-sm-8">
                            <select class="custom-select form-control" id="formCustomSelect" name="courseName" value="{{ old('courseName') }}">
                    ...
                    <div class="form-group">
                        <label for="course_semester" class="control-label col-sm-4" style="text-align: left">Semester:</label>
                        <div class="col-sm-8">
                    ...
                    <div class="form-group">
                        <label for="course_id" class="control-label col-sm-4" style="text-align: left">Section:</label>
                        <div class="col-sm-8">
